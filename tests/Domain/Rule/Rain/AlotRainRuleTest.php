...
class AlotRainRuleTest extends TestCase
{
    ...
    public function shouldReturnKutRating()
    {
        ...
        $this->assertEquals(Rating::kut(), $rating, 'Expected a lot of rain to return a kut rating');
    }
    ...
    public function shouldMatchForAlotRain()
    {
        ...
        $this->assertTrue($matched, 'Alot of rain rule should match for 15mm rain');
    }
    ...
    public function shouldNotMatchForNoRain()
    {
        ...
        $this->assertFalse($matched, 'Alot of rain rule should not match for 5mm rain');
    }
    ...
    public function shouldNotMatchForALittleRain()
    {
        ...
        $this->assertFalse($matched, 'Alot of rain rule should not match for 0mm rain');
    }
    ...
    public function shouldNotMatchForUnknownRain()
    {
        ...
        $this->assertFalse($matched, 'Alot of rain rule should not match for an unknown amount rain');
    }
}
